		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (idTextFeld.getText().matches("[+-]?[0-9]+") && idTextFeld.getText().length() != 0
						&& passwortTextFeld.getText().length() != 0) {

//					if (datenklassen.MitarbeiterVerwaltung
//							.isLoginSuccesfull(Integer.parseInt(idTextFeld.getText()), passwortTextFeld.getText())) {
//						JOptionPane.showMessageDialog(null, "erfolgreich", "Anmeldung",
//								JOptionPane.INFORMATION_MESSAGE);
//					}

					JOptionPane.showMessageDialog(null, "erfolgreich", "Anmeldung", JOptionPane.INFORMATION_MESSAGE);

				} else {
					JOptionPane.showMessageDialog(null, "Bitte füllen sie die Angegebenen Informationen ein",
							"Anmeldung", JOptionPane.ERROR_MESSAGE);
				}
